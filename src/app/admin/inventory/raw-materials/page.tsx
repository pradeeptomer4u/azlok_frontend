...
export default function RawMaterialsPage() {
  ...
  useEffect(() => {
    ...
    fetchRawMaterials();
  }, [currentPage, sortField, sortOrder, searchTerm, selectedCategory, filter]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link 
          href="/admin/inventory/raw-materials/create" 
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                router.push(`/admin/inventory/raw-materials?${params.toString()}`);
              }}
              className="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
            >
              ...
              {rawMaterials.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link href={`/admin/inventory/raw-materials/${item.id}`} className="text-indigo-600 hover:text-indigo-900 mr-3">
                      View
                    </Link>
                    <Link href={`/admin/inventory/raw-materials/edit/${item.id}`} className="text-blue-600 hover:text-blue-900 mr-3">
                      Edit
                    </Link>
                    <button
              ...
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">
                    {Math.min(currentPage * itemsPerPage, rawMaterials.length + (currentPage - 1) * itemsPerPage)}
                  </span>{' '}
                  of <span className="font-medium">{rawMaterials.length + (currentPage - 1) * itemsPerPage}</span> results
                </p>
              </div>
              <div>
