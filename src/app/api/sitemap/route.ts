  ...
  try {
    ...
    try {
      ...
      const mainPages = [
        ...
        { url: '/products/azlok-kali-mirch-black-pepper-whole', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-saunf-fennel-seeds', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-laung-cloves', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-badi-elaichi-black-cardamom', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-sabut-safed-mirch-white-pepper-whole', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-chhoti-elaichi-green-cardamom', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-dal-chini-cinnamon-sticks', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-dhania-sabut-whole-coriander-seeds', priority: '0.8', changefreq: 'daily' },
        { url: '/products/azlok-tej-patta-bay-leaf', priority: '0.8', changefreq: 'daily' },
