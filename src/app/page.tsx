  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-10 bg-blue-50">
        <div className="container-custom mx-auto">
          <h2 className="text-2xl font-bold text-center mb-10 text-gray-800">Why Shop with Azlok?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">All products undergo rigorous quality checks before approval.</p>
            </div>
            <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
              <div className="bg-primary bg-opacity-10 rounded-full p-4 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Enjoy quick and reliable delivery to your doorstep across the country.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container-custom mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/products?sort=trending" className="text-primary hover:underline">
              View All
            </Link>
          </div>
          <TrendingProducts />
      ...
      <section className="py-10">
        <div className="container-custom mx-auto">
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-10">What Our Customers Say</h2>
          <TestimonialSection />
        </div>
      </section>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container-custom mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-gray-800">Start Shopping Today!</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-600">Join thousands of satisfied customers who love shopping at Azlok.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" className="bg-gray-100 text-gray-800 font-semibold py-3 px-6 rounded-md hover:bg-gray-200 transition-colors border border-gray-300">
              Create Account
            </Link>
            <Link href="/products" className="bg-primary text-gray-800 font-semibold py-3 px-6 rounded-md hover:bg-primary-dark transition-colors">
              Shop Now
            </Link>
          </div>
        </div>
