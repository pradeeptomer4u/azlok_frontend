            ...
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
              ...
              <div className="relative max-w-xl">
                <input 
                  ...
                  className="w-full py-4 px-6 pr-12 rounded-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-lg"
                />
                <button className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-green-600 hover:bg-green-700 text-white p-2 rounded-full transition-colors">
