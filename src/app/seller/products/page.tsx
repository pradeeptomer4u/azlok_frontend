...
const mockProducts = [
  ...
  {
    id: 5,
    name: 'Hydraulic System Component',
    sku: 'HSC-005',
    price: 8500,
    stock: 0,
    category: 'Hydraulic Components',
  ...
  {
    id: 7,
    name: 'High-Pressure Valve System',
    sku: 'HPV-007',
    price: 7500,
    stock: 0,
    category: 'Hydraulic Components',
                ...
                <tr key={product.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-xs text-gray-500">Added {formatDate(product.createdAt)}</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end space-x-2">
                      <Link href={`/seller/products/${product.id}`} className="text-primary hover:text-primary-dark">
                        View
                      </Link>
                      <Link href={`/seller/products/edit/${product.id}`} className="text-indigo-600 hover:text-indigo-900">
                        Edit
                      </Link>
