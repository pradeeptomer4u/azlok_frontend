          ...
          <div className="lg:w-2/3 order-2 lg:order-1">
            <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 border border-green-100/50 relative overflow-hidden group">
              ...
              <motion.div {...fadeInUp} className="relative z-10">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 transform transition-transform duration-300 group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
