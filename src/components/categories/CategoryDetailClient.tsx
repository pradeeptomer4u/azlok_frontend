    ...
    const fetchCategory = async (retryCount = 0) => {
      ...
      try {
        ...
        if (foundCategory) {
          ...
          const products = await productService.getProductsByCategorySlug(foundCategory.slug, 100);
          
          // Store the products for schema
          ...
          if (fuzzyMatch) {
            ...
            const products = await productService.getProductsByCategorySlug(fuzzyMatch.slug, 100);
        ...
        <div className="container-custom mx-auto py-10 relative z-10">
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-red-100 max-w-2xl mx-auto">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 font-['Playfair_Display',serif]">
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f0f9ff] to-[#f8fdfb]">
      ...
      {categoryProducts.length > 0 && (
        <ProductListSchema 
          ...
          listName={`${category.name} Products`}
        />
      )}
