                ...
                >
                  ...
                  {isAuthenticated ? (
                    <>
                      ...
                      {hasAnyAdminAccess && (
                        <Link href="/admin" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors duration-150 border-t border-gray-100" onClick={() => setIsUserMenuOpen(false)}>
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-3 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
